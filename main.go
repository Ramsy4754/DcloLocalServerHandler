...
func startAdminServerHandler(w http.ResponseWriter, r *http.Request) {
	...
	adminServerCmd = exec.Command("D:/00_Development/Dclo_Admin/.venv/Scripts/python.exe", "D:/00_Development/Dclo_Admin/run.py")
...
func startDcloServerHandler(w http.ResponseWriter, r *http.Request) {
	...
	dcloServerCmd = exec.Command("D:/00_Development/Dclo_Back/venv/Scripts/python.exe", "D:/00_Development/Dclo_Back/run.py")
